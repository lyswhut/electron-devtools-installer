...
const install = (extensionReference, options = {}) => {
    ...
    const { forceDownload, loadExtensionOptions, session = electron_1.session.defaultSession } = options;
